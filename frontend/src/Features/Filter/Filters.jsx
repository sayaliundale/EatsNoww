    ...
    return (
        <>
            <div className="flex flex-wrap ml-[10%] gap-3 my-4">
                ...
                <div
                    className={`px-4 py-2 border border-gray-300 rounded-full text-sm hover:shadow-md cursor-pointer ${currentFilter === "veg" ? "bg-green-100" : ""
                        }`}
                ...
                <div
                    className={`px-4 py-2 border border-gray-300 rounded-full text-sm hover:shadow-md cursor-pointer ${currentFilter === "non-veg" ? "bg-red-100" : ""
                        }`}
                ...
                <div
                    className={`px-4 py-2 border border-gray-300 rounded-full text-sm hover:shadow-md cursor-pointer ${currentFilter === "rating" ? "bg-yellow-100" : ""
                        }`}
                ...
                <div
                    className={`px-4 py-2 border border-gray-300 rounded-full text-sm hover:shadow-md cursor-pointer ${currentFilter === "maharashtrian" ? "bg-blue-100" : ""
                        }`}
                    onClick={() => onFilterChange("maharashtrian")}
                >
                    Maharashtrian
                </div>
